...
<body class="top-navigation gray-bg">
	<form:form name="createJobForm" id="createJobForm" commandName="jobCommand" action="createJob.do"
		method="post">
						...
						<div class="ibox-content">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
									<form:select path="keySkills" id="keySkills" class="chosen-select"
											multiple="true" style="width:300px;">
											<form:option value="" >-- Select Skills --</form:option>
											<c:forEach items="${skillsList}" var="skil">
	      										<form:option value="${skil.id}" >${skil.name}</form:option> 
											</c:forEach>
									</form:select>
										<%-- <form:input path="keySkills" id="keySkills"
											class="form-control" /> --%>
									</div>
								</div>
							</div>

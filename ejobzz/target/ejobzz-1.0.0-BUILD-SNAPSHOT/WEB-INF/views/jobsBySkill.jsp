...
<body class="top-navigation gray-bg">
		...
		<div class="row">
				...
				.ibox-content h3	{	line-height:25px;}</style>
						...
						<a href="GetJobsBySkill.do?skill=java"><h3>Java</h3></a>
						<a href="GetJobsBySkill.do?skill=jee"><h3>J2EE</h3></a>
							<a href="GetJobsBySkill.do?skill=spring"><h3>Spring</h3></a>
		
						<a href="GetJobsBySkill.do?skill=hibernate"><h3>Hibernate</h3></a>
						<a href="GetJobsBySkill.do?skill=mysql"><h3>MYSQL</h3></a>
		
						<a href="GetJobsBySkill.do?skill=css"><h3>CSS</h3></a>
						<a href="GetJobsBySkill.do?skill=html"><h3>HTML</h3></a>
						<a href="GetJobsBySkill.do?skill=c"><h3>C</h3></a>
						<a href="GetJobsBySkill.do?skill=php"><h3>PHP</h3></a>
						<a href="GetJobsBySkill.do?skill=wordpress"><h3>Word Press</h3></a>

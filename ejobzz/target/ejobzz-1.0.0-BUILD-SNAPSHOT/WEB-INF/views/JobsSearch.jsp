...
<body class="top-navigation gray-bg">
		...
		<div class="ibox-content" id="searchtext">
                        <div class="list-group">
                            <a class="list-group-item" href="jobDetails.do?jobId=${job.jKey}" style="width: 50%; margin: 0px auto;">
                         					<h3 class="list-group-item-heading" style="color:black; ">${job.title}</h3>
                               

                                <p class="list-group-item-text">
		
					<font style="color:green;">${job.company.name}</font><br/>
					Exp : ${job.minExpYear} years - ${job.maxExpYear} years  <br/>
					 Loc : ${job.location}<br/>

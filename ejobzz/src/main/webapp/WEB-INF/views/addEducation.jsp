			...
			<div class="row">
				...
				<div class="ibox-content">
					<form:form id="education" commandName="jobseekerRegisterDTO"
						class="form-horizontal" action="addEducationPost.do" method="POST" onsubmit="return validateEducation()"
						>
						<h3>
						...
						<div class="row">
								<div class="form-group"> -->
									...
									<div class="col-md-4">
										...
										<form:input path="dto.ename" class="form-control" name="ename"  id="ename"></form:input>
											<label for="etype" class="error" id="ename-error"></label>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group"> -->
									...
									<div class="col-md-4">
									<form:input path="dto.specialization" name="specialization" id="specialization" class="form-control" ></form:input>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<form:select path="dto.university" name="university" id="university"
											...
											<label for="university" class="error" id="university-error"></label>
									</div>

					...
					<div class="ibox-content">
						...
						<div class="feed-activity-list">
							...
							<div class="feed-element">
								...
								<hr/>
								<form action="RefineSearchRole.do" method="post">
								<div class="row">
									...
									<div class="form-group">
										<label class="col-sm-6 control-label">Any Key Word</label>
									...
									<div class="form-group">
										<label class="col-sm-6 control-label">Exclude Key Word</label>
...
<input type='hidden' id='show_per_page' /> 
				...
				<br/><br/><br/>
				<form:form name="form" commandName="RoleSearchDto" action="modifyroleSearch.do" method="post" >
								...
								&nbsp;&nbsp;&nbsp;&nbsp;<a href="roleSearch.do" class="btn btn-primary" >New Search</a>
						 </form:form>
								...
								<c:forEach items="${JobSeekerList}" var="jobSeeker">
									...
									<input type="checkbox" id="emailchecked" name="emailchecked" class="checkbox1"value="${jobSeeker.email}"/>
										...
										<a class="list-group-item" href="preview.do?jsid=${jobSeeker.jsid}">
											<h4 class="list-group-item-heading" style="color: #0079D0; font-style: bold">Tittle...</h4>
	...
	var pager = new Imtech.Pager();
		...
		$(document).ready(function() {
		    ...
		    pager.paragraphsPerPage = 50; // set amount elements per page

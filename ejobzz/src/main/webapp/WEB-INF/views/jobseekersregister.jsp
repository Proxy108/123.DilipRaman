  ...
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a  href="jobSeekerLogin.do">Allready Registered? Sign In</a></li>
        <li><a  href="ForgotPassword.do">Forgot Password?</a></li>
         <li><a  href="ForgotPassword.do">Report Problem</a></li>
      </ul></div>
  </div>
</nav>
					...
					<div class="ibox-content">
						...
						<form:form  id="myform" commandName="jobseekerRegisterDTO" class="form-horizontal" action="createRegister.do" enctype="multipart/form-data" method="POST" >
                			...
                			<div class=" col-md-4">
									...
									<label class="col-sm-2 control-label">Pref Location<font color="red">*</font></label>
